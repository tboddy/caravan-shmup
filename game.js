var canvas = document.getElementById('canvas'), canvasEl = $('canvas'), fps = 29.97, gameClock = 0, grid = 16, gameHeight = 240, gameWidth = 256, isFullscreen = false, gameLoopInterval, 
	browserWindow = require('electron').remote, dropXSpeed = grid  / 3, dropXMax = grid * 6, storage = require('electron-json-storage'), savedData = {},
...
var levelMap = [
	...
	['g', 'r', 'g', 'n', ' ', ' ', 'v', 'b', 'b', 'N', ' ', ' (2)', 'X','g','r','g'],
	['g', 'r', 'g', 'n', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' (2)', 'X','g','r','g'],
	['g', 'r', 'g', 'z', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' (2)', 'Z','g','r','g'],
	['g', 'r', 'g', 'n', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' (2)', 'X','g','r','g'],
	['B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B (2)','B','B','B','B'],
	['B', 'r', 'G', 'r', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B (2)','r','g','r','B'],
	['B', 'g', 'g', 'g', 'g', 'g', 'g', 'B', 'B', 'g', 'g', 'g (2)','g','g','g','B'],
	['B', 'r', 'g', 'r', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B (2)','r','G','r','B'],
	['B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B (2)','B','B','B','B'],
	['B', 'M', 'B', 'M', 'B', 'M', 'B', 'M', 'B', 'M', 'a', 'b (2)','b','b','b','b'],
	['g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'n', ' ', ' ', ' ', ' ', ' '],
	['r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'r', 'n', ' ', ' ', ' ', ' ', ' '],
	['g', 'K', 'L', 'g', 'g (2)', 'g', 'g', 'K', 'L', 'g', 'n', ' ',' ',' ',' ',' '],
	['r', 'k', 'l', 'r', 'r (2)', 'r', 'r', 'k', 'l', 'r', 'z', ' ',' ',' ',' ',' '],
	['g', 'g', 'g', 'g', 'g (2)', 'g', 'g', 'g', 'g', 'g', 'n', ' ',' ',' ',' ',' '],
	['r', 'r', 'r', 'r', 'r (2)', 'r', 'r', 'r', 'r', 'r', 'n', ' ',' ',' ',' ',' '],
	['B', 'B', 'B', 'B', 'B (2)', 'B', 'B', 'M', 'g', 'M', 'B', 'B','B','B','B','B'],
	['B', 'g', 'r', 'g', 'r (2)', 'B', 'B', 'g', 'r', 'g', 'B', 'B','B','B','B','B'],
	['B', 'g', 'r', 'g', 'r (2)', 'B', 'B', 'M', 'r', 'M', 'B', 'B','B','B','B','B'],
	['b', 'b', 'A', 'g', 'r (2)', 'B', 'B', 'B', 'B', 'B', 'B', 'B','M','g','M','B'],
	[' ', ' ', 'X', 'g', 'r (2)', 'B', 'B', 'B', 'B', 'B', 'B', 'B','g','R','g','B'],
	[' ', ' ', 'X', 'B', 'B (2)', 'B', 'B', 'M', 'g', 'M', 'B', 'B','M','g','M','B'],
	...
	['g', 'r', 'g', 'r', 'a', 'N', 'V', 'r', 'g', 'r', 'g', 'r (1)','g','r','g','r'],
	['g', 'r', 'g', 'r', 'n', ' ', 'X', 'g', 'r', 'g', 'r', 'g (1)','r','g','G','g'],
	['g', 'r', 'g', 'r', 'W', 'w', 'e', 'M', 'g', 'r', 'g', 'M (1)','g','r','g','M'],
	['g', 'r', 'G', 'r', 'W', 'w', 'e', 'B', 'B', 'B', 'B', 'B (1)','M','r','M','B'],
	['g', 'r', 'g', 'R', 'n', ' ', 'v', 'b', 'b', 'b', 'A', 'B (1)','g','M','g','B'],
	['b', 'b', 'b', 'b', 'N', ' ', ' ', ' ', ' ', ' ', 'X', 'B (1)','M','r','M','B'],
	[' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'X', 'B (1)','B','B','B','B'],
	[' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Z', 'g (1)','g','M','r','r'],
	[' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'X', 'g', 'g', 'B', 'r', 'r'],
	[' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'X', 'g', 'g', 'M', 'r', 'r'],
	...
	[' ', ' ', ' ', ' ', ' (1)', ' ', ' ', ' ',' ',' ','X', 'g', 'g', 'B', 'R','r'],
	[' ', ' ', ' ', ' ', ' (1)', ' ', ' (p)', ' ',' ',' ','Z', 'g', 'g','M','r','r'],
	['r', 'g', 'r', 'm', ' (1)', ' ', ' ', ' ',' ',' ','Z', 'g', 'g', 'B', 'r', 'r'],
	['M', 'B', 'M', 'z', ' (1)', ' ', ' ', ' ', ' ', ' ', 'X', 'g', 'g','M','r','r'],
	['r', 'g', 'r', 'n', ' (1)', ' ', ' ', ' ', ' ', ' ', 'v', 'b', 'A','B','r','r'],
	['g', 'r', 'g', 'n', ' (1)', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Z','M','B','M'],
	['r', 'G', 'r', 'n', ' (1)', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'v','b','b','b'],
	['g', 'M', 'g', 'n', ' (1)', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',' ',' ',' '],
	['r', 'g', 'r', 'z', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '],
